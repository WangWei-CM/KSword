...
namespace
{
    ...
    // - 欢迎页显示的版本号文本；
    // - 由发布脚本按注释标记替换。
    const QString kReleaseVersionText = QStringLiteral("5.1.2.0发布前调试版.1"); // RELEASE_META_VERSION_MARKER
...
WelcomeDock::WelcomeDock(QWidget* parent) : QWidget(parent) {
    ...
    m_donors->setText(QStringLiteral("<b>捐赠者：</b>Extrella_Explorer,NtKrnl64,一花一树叶,hzh"));
