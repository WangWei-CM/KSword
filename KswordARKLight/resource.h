...
// resource.h defines only KswordARKLight-owned resource identifiers. Inputs are
// project-local numeric ids used by the .rc file; resource consumers load them
