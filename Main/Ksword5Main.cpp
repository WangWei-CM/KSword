...
private:
    ...
    bool m_mainWindowCreated = false;
    bool m_runOnceHideMainWnd = false;
    bool m_mainWindowClosed = false;
    //bool m_shouldExit = false;
    std::unique_ptr<Logger> m_logger;
    HMODULE m_hD3DX9Module{nullptr};
...
public:
    Application() : m_logger(std::make_unique<Logger>()) {}
...
private:
    ...
    void shutdown() {
        ...
        // 2. 检查是否有未关闭的模块
        ModuleManager::preImGuiShutdown();
